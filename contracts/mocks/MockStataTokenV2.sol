...
/**
 * @title MockStataTokenV2
 * @notice Test-only static-a-token mock with ERC4626-style wrap and unwrap semantics.
 */
contract MockStataTokenV2 is ERC20, IERC4626 {
    ...
    constructor(address aToken_, address asset_) ERC20("Mock Static AToken", "mstata") {
        if (aToken_ == address(0) || asset_ == address(0)) revert InvalidParam();
        aToken = aToken_;
