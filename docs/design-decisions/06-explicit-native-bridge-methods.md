...
The old emergency bridge methods were removed. Incident-time bridge restoration is now an explicit deallocate-then-rebalance workflow rather than a separate vault surface.
