...
- temporary SGHO illiquidity remains fail-closed and is not reclassified as reimbursable fee.
...
- reimbursement never substitutes for missing withdrawable liquidity on the SGHO exit path.
