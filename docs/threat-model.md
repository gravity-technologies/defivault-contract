...
- Mitigations: multisig ownership, hardware-key policies, timelock for high-impact config changes, separate hot/cold duties, monitoring alerts for role/config mutations.
